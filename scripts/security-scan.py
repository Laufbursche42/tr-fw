#!/usr/bin/env python3
"""Dependency-free security + structure scanner for the tr-fw static web app.
...
# way: three escHtml() calls and one bare, unescaped variable on one scan-ok'd
# line. This second pass parses each innerHTML assignment's right-hand side for
# real and requires every '+'-joined piece to be a string literal or an
